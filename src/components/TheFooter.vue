<template>
  <footer class="footer">
    <div class="footer__wrapper container">
      ...
      <p class="footer__desc">Все права на&nbsp;материалы, находящиеся на&nbsp;сайте, охраняются в&nbsp;соответствии с&nbsp;законодательством&nbsp;РФ, в&nbsp;том числе об&nbsp;авторском праве и&nbsp;смежных правах.</p>
      ...
      <span class="footer__copyright">© 2021 Технозавррр</span>
    </div>
  </footer>
</template>